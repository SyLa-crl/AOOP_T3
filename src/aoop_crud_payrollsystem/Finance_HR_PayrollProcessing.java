...
import static aoop_crud_payrollsystem.StatutoryDeductions.calculatePagIbig;
import static aoop_crud_payrollsystem.StatutoryDeductions.calculatePhilHealth;
import static aoop_crud_payrollsystem.StatutoryDeductions.calculateSSS;
import static aoop_crud_payrollsystem.StatutoryDeductions.calculateWHTax;
 ...
 * @author Sylani
 */
public final class Finance_HR_PayrollProcessing extends javax.swing.JFrame {
     ...
     */
    public Finance_HR_PayrollProcessing() throws FileNotFoundException, IOException, CsvException {
    ...
    public static class EmployeeHoursWorked {
    ...
    public EmployeeHoursWorked(String employeeNumber, String lastName, String firstName, 
                              String coveredPeriod, String noOfHoursWorked) {
    ...
    public String getCoveredPeriod() { return coveredPeriod; }
    public String getNoOfHoursWorked() { return noOfHoursWorked; }
    
    // Setters
    public void setEmployeeNumber(String employeeNumber) { this.employeeNumber = employeeNumber; }
    public void setLastName(String lastName) { this.lastName = lastName; }
    public void setFirstName(String firstName) { this.firstName = firstName; }
    public void setCoveredPeriod(String coveredPeriod) { this.coveredPeriod = coveredPeriod; }
    public void setNoOfHoursWorked(String noOfHoursWorked) { this.noOfHoursWorked = noOfHoursWorked; }
}
    ...
    public boolean isUniqueCompute() throws CsvException {
        try {
            ...
            Logger.getLogger(Finance_HR_PayrollProcessing.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void resetButtonColors() {
        ...
        PayrollProcessing.setForeground(Color.BLACK);
    ...
    // Already on dashboard, just show a message
    ...
    private void showUserManagement() throws IOException, FileNotFoundException, CsvException {
        ...
        // Get employee number - you can use the current logged-in employee or default admin
        String employeeNumber = "0"; // Default admin - you might want to use actual employee ID
    ...
    private void showPayrollProcessing() {
        ...
        // Don't dispose this window, keep both open
    } catch (IOException | CsvException ex) {
        Logger.getLogger(Finance_HR_PayrollProcessing.class.getName()).log(Level.SEVERE, "Error opening payroll processing", ex);
    ...
    private void initComponents() {
        ...
        PayrollProcessing.setBackground(new java.awt.Color(153, 255, 204));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel24, javax.swing.GroupLayout.DEFAULT_SIZE, 1001, Short.MAX_VALUE)
                .addContainerGap())
    ...
    private void jButtonPayrollSummaryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPayrollSummaryActionPerformed
            ...
            setVisible(false);
            // Get the employee number - you can use the current employee or a default value
            // Since this appears to be from payroll processing, you might have the employee info available
            String employeeNumber = "0"; // Default admin or use actual employee number if available
            
            UserManagement userManagement = null;
        try {
            userManagement = new UserManagement(employeeNumber);
        } catch (IOException | CsvException ex) {
            Logger.getLogger(Finance_HR_PayrollProcessing.class.getName()).log(Level.SEVERE, null, ex);
        }
            userManagement.setVisible(true);
            userManagement.pack();
            userManagement.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Finance_HR_PayrollProcessing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                try {
                    new Finance_HR_PayrollProcessing().setVisible(true);
