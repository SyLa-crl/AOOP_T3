...
public class HR_Dashboard extends javax.swing.JFrame {
    ...
    /**
     * Creates new form HR_Dashboard with employee info
     * @param employeeInfo Array containing [employeeNumber, lastName, firstName]
     */
    public HR_Dashboard(String[] employeeInfo) {
         this.employeeInfo = employeeInfo;
    initComponents();
    
    // Display welcome message
    String welcomeMessage = "Welcome to HR Dashboard\nEmployee: " + 
                           employeeInfo[0] + " - " + employeeInfo[2] + " " + employeeInfo[1];
    JOptionPane.showMessageDialog(this, welcomeMessage, "HR Dashboard", 
    ...
    resetButtonColors();
    Dashboard.setBackground(new Color(204, 102, 255));
    ...
    private void resetButtonColors() {
        ...
        Employees.setBackground(new Color(204, 153, 255));
        Employees.setForeground(Color.BLACK);
        LeaveManagement.setBackground(new Color(204, 153, 255));
        LeaveManagement.setForeground(Color.BLACK);
    ...
    private void showDashboard() {
        JOptionPane.showMessageDialog(this, "You are already on the Dashboard!", 
    ...
    private void showEmployeeManagement() {
        try {
            ...
            Logger.getLogger(HR_Dashboard.class.getName()).log(Level.SEVERE, 
                            "Error opening employee management", ex);
            JOptionPane.showMessageDialog(this, "Error opening employee management: " + ex.getMessage(), 
    ...
    private void showLeaveManagement() {
        try {
            HR_LeaveApplication leaveForm = new HR_LeaveApplication();
            WindowUtils.switchToWindow(this, leaveForm);
        } catch (Exception ex) {
            Logger.getLogger(HR_Dashboard.class.getName()).log(Level.SEVERE, 
                            "Error opening leave management", ex);
            JOptionPane.showMessageDialog(this, "Error opening leave management: " + ex.getMessage(), 
                                        "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void showPayrollSummary() {
      ...
      try {
        ...
        Logger.getLogger(HR_Dashboard.class.getName()).log(Level.SEVERE, 
                      "Error opening payroll summary", ex);
    ...
    private void signOut() {
        ...
        if (response == JOptionPane.YES_OPTION) {
            try {
                ...
                Logger.getLogger(HR_Dashboard.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        Dashboard.setBackground(new java.awt.Color(204, 102, 255));
        ...
        LeaveManagement.setBackground(new java.awt.Color(204, 153, 255));
        LeaveManagement.setText("Leave Management");
        LeaveManagement.setBorder(null);
        LeaveManagement.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ...
        Employees.setBackground(new java.awt.Color(204, 153, 255));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(PayrollSummary, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Employees, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(LeaveManagement, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(2, 2, 2)
                .addComponent(Employees, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(LeaveManagement, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jLabel4.setText("Pending Leave Request");
    ...
    private void LeaveManagementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LeaveManagementActionPerformed
        ...
        showLeaveManagement();
        resetButtonColors();
        LeaveManagement.setBackground(new Color(204, 102, 255));
        LeaveManagement.setForeground(Color.WHITE);
    ...
    private void EmployeesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EmployeesActionPerformed
        ...
        resetButtonColors();
        Employees.setBackground(new Color(204, 102, 255));
    ...
    private void PayrollSummaryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PayrollSummaryActionPerformed
        showPayrollSummary();
        resetButtonColors();
        PayrollSummary.setBackground(new Color(204, 102, 255));
        PayrollSummary.setForeground(Color.WHITE);
    }//GEN-LAST:event_PayrollSummaryActionPerformed

    private void SignOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignOutActionPerformed
        // TODO add your handling code here:        // Sign Out button - Return to Login Manager
    int response = JOptionPane.showConfirmDialog(
        this,
        "Are you sure you want to sign out?",
        "Confirm Sign Out",
