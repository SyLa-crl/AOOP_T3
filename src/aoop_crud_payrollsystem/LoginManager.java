...
public class LoginManager extends javax.swing.JFrame {
     ...
     */
//Calls initComponents() to load the GUI layout (auto-generated by NetBeans).
//Deletes the old user_types.csv to ensure a clean start.
//Calls helper methods to set up files and form behavior.
//Configures the window (title, close behavior, resizability).
//Listens for resize events to keep UI centered.
    public LoginManager() {
    initComponents();
    fixFormSize();
